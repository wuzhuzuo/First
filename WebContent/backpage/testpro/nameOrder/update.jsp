	...
	<div class="main">
		...
		<div class="centent" style="padding-top: 10px;">
			<form id="dataForm" name="dataForm" method="post"
				enctype="multipart/form-data" action="${ctx}/back/txno_update.do">
				
				<table cellpadding="0" cellspacing="0" border="0" class="uiTable"
					id="tempMess">
					<tr>
						<td align="left">序号： ${txno.txnoId}
						<input type="hidden" name="txnoId"	id="txnoId" value="${txno.txnoId}">
						</td>
					</tr>
					...
					<tr>
						<td align="left">姓名： <input type="text" name="txnoName"
							id="txnoName" value="${txno.txnoName}" class="validate[required,length[0,10]]">
						</td>
					</tr>
					...
					<tr>
						<td align="left">考号： <input type="text" name="txnoSpare1"
							id="txnoSpare1" value="${txno.txnoSpare1}" >
						</td>
					</tr>
					...
					<tr>
						<td align="left">备注： 
						<textarea name="txnoRemark" id="txnoRemark" >${txno.txnoRemark}</textarea>
						</td>
					</tr>
